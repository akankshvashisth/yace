...
static type_array<move, Constants::max_moves_per_position>& GeneratePseudoLegalCaptureMoves( Bitboard& bb, type_array<move, Constants::max_moves_per_position>& mvs );
...
static type_array<move, 64>& GeneratePseudoLegalCaptureMoves( Bitboard& bb, type_array<move, 64>& mvs )
{
	mvs.clear();
	const bool isWhitesTurn = bb.IsWhitesTurn();
	ui64 pawns, bishops, rooks, queens, knights, king, opponent, self, opponentOrEp;
